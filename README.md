...
Focuses on Bangalore dining scene, highlighting popular chains like Jalsa and Spice Elephant. 🌶️🍛
...
Environment: Jupyter Notebook (.ipynb format, interactive on GitHub) 💻.
...
Launch Jupyter: jupyter notebook ZomatoDataAnalysis.ipynb ▶️.

Ensure "Zomato data .csv" is in the same folder for data loading. ✅
